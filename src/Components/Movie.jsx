  ...
  return (
    <>
      ...
      <div className="single-movie bg-dark text-black">
        <div className="background-image" style={{ backgroundImage: `url(${singleMovie.singleMovie.backgroundImage})` }}></div>
        <div className="content gap-5 d-flex">
          <div className="video m-4">
            <Link to={`/movieTrailer/${singleMovie.movieId}`}>
              <div className="image-container" style={{ position: "relative", width: "80%", height: "450px",marginLeft:"5%" }}>
                <img
                  src={singleMovie.movieImage}
          ...
          <div className="text-white" style={{ marginTop: "5%" }}>
            ...
            <Link to={`/theaters/${singleMovie.movieId}/${currentdate}`}><button className="btn btn-primary ">Book now</button></Link>
          </div>
        </div>
      </div>
      <Footer />
